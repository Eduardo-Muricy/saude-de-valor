...
export default function VideoSide() {
    ...
    return (
        ...
        <div className="bg-[#7D8E73] py-6  flex flex-col justify-center items-center  ">
            ...
            <div className="bg-[#FF6A00] text-[#E4EBE0] px-14 md:px-50 py-4  text-md md:text-2xl font-bold rounded-md shadow-lg"><Link href="/">QUERO SER MAIS VALORIZADO </Link></div>
        </div>
    )
